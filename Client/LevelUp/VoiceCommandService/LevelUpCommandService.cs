...
{
    public sealed class LevelUpVoiceCommandService : IBackgroundTask
    {
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            if (triggerDetails != null && triggerDetails.Name == "LevelUpCommandService")
            {
                try
                {
